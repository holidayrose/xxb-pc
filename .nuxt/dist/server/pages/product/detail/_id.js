...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  head() {
    return {
      title: this.productDetailObj.productObj.NAME + '怎么样？_' + this.productDetailObj.productObj.NAME + '的用户口碑_用户评价_用户点评_选型宝',
      meta: [{
        hid: 'description',
        name: 'description',
        content: '想了解' + this.productDetailObj.productObj.NAME + '的用户口碑好不好，' + this.productDetailObj.productObj.NAME + '怎么样？就上选型宝, 企业级软件的大众点评'
      }, {
        hid: 'keywords',
        name: 'keywords',
