exports.ids = [38,2,6,7,9,10,11,12,17,18,20,23,25,26,28];
exports.modules = {
...
var feature = __webpack_require__(219);

// EXTERNAL MODULE: ./components/productDetail/reviews.vue + 4 modules
var reviews = __webpack_require__(220);
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  async asyncData(vm) {
    ...
    * */
    ...
    let disadvantageReviews = []; // 产品对比列表

    let vsProdtcListRes = await vm.$requests.categoryVsProduct({
      category_id: productDetailObj.categoryObj.CID
    });
    console.log('产品对比列表的结果:', vsProdtcListRes);
    return {
      productId,
      // 产品ID
      productDetailObj,
