...
// CONCATENATED MODULE: ./node_modules/_vue-loader@15.9.7@vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/_@nuxt_components@2.1.8@@nuxt/components/dist/loader.js??ref--0-0!./node_modules/_vue-loader@15.9.7@vue-loader/lib??vue-loader-options!./pages/product/rank/_id.vue?vue&type=template&id=3ca44f55&
...
// CONCATENATED MODULE: ./pages/product/rank/_id.vue?vue&type=template&id=3ca44f55&

// EXTERNAL MODULE: ./components/ProductOrder.vue + 4 modules
var ProductOrder = __webpack_require__(209);
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  head() {
    return {
      title: this.categoryName + '软件排名_' + this.categoryName + '软件点评_' + this.categoryName + '软件是什么意思？选型宝',
      meta: [{
        hid: 'description',
        name: 'description',
        content: '想了解' + this.categoryName + '软件排名、' + this.categoryName + '软件怎么选、' + this.categoryName + '软件是什么意思？就上选型宝, 企业级软件的大众点评'
      }, {
        hid: 'keywords',
        name: 'keywords',
        content: this.categoryName + '软件_' + this.categoryName + '是什么意思？'
      }]
    };
  }
