...
var BarZoomSmall = __webpack_require__(206);
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  head() {
    return {
      title: this.categoryName + '系统排名_' + this.categoryName + '系统的用户点评_' + this.categoryName + '系统是什么？选型宝',
      meta: [{
        hid: 'description',
        name: 'description',
        content: '想了解' + this.categoryName + '系统的厂商排名、' + this.categoryName + '系统的用户点评、' + this.categoryName + '系统是什么？就上选型宝, 企业级软件的大众点评'
      }, {
        hid: 'keywords',
        name: 'keywords',
        content: this.categoryName + '系统_' + this.categoryName + '是什么？'
      }]
    };
  }
