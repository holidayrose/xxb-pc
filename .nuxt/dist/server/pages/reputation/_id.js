exports.ids = [38,6,7,8,9,10,11,16,22,24,25,27];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/_vue-loader@15.9.7@vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/_@nuxt_components@2.1.8@@nuxt/components/dist/loader.js??ref--0-0!./node_modules/_vue-loader@15.9.7@vue-loader/lib??vue-loader-options!./pages/reputation/_id.vue?vue&type=template&id=cc7f5aa4&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main"},[_vm._ssrNode("<h1 class=\"heading-hide\">"+_vm._ssrEscape("\n    "+_vm._s(_vm.companyInfo.factoryQcObj.FACTORY_SHORT_NAME)+_vm._s(_vm.categoryName)+"怎么样？_"+_vm._s(_vm.companyInfo.factoryQcObj.FACTORY_SHORT_NAME)+"公司怎么样？_"+_vm._s(_vm.companyInfo.factoryQcObj.FACTORY_SHORT_NAME)+_vm._s(_vm.categoryName)+"多少钱？选型宝\n  ")+"</h1> "),_c('a-anchor',{staticClass:"default"},[_c('Header2',{attrs:{"is-show":true},on:{"handleBannerPopShow":_vm.handleBannerPopShow}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"container-index\">","</div>",[_c('breadCrumb',[_c('a-breadcrumb-item',[_c('nuxt-link',{attrs:{"to":"/"}},[_vm._v("\n          首页\n        ")])],1),_vm._v(" "),_c('a-breadcrumb-item',[_c('nuxt-link',{attrs:{"to":{name: 'product-rank-id',params:{id: _vm.categoryId}},"target":"_blank"}},[_vm._v("\n          "+_vm._s(_vm.categoryName)+"软件排名\n        ")])],1),_vm._v(" "),_c('a-breadcrumb-item',[_vm._v("\n        "+_vm._s(_vm.companyInfo.factoryQcObj.FACTORY_SHORT_NAME)+"综合口碑\n      ")])],1),_vm._ssrNode(" "),_c('a-row',[_c('a-col',{attrs:{"span":24}},[_c('a-row',{staticClass:"g-wrapper",attrs:{"gutter":[32, 32]}},[_c('a-col',{attrs:{"span":16}},[_c('div',{staticClass:"company-info-wrap g-flex space-between"},[_c('div',{staticClass:"company-name left"},[_c('div',{staticClass:"short-name"},[_vm._v("\n                  "+_vm._s(_vm.companyInfo.factoryQcObj.FACTORY_SHORT_NAME)+"\n                ")]),_vm._v(" "),_c('div',{staticClass:"full-name"},[_vm._v("\n                  "+_vm._s(_vm.companyInfo.factoryQcObj.QCNAME)+"\n                ")]),_vm._v(" "),_c('div',{staticClass:"g-flex"},[_c('div',{staticClass:"category"},[_vm._v("\n                    "+_vm._s(_vm.categoryName)+"类\n                  ")]),_vm._v(" "),_c('img',{staticClass:"hot-icon",attrs:{"src":__webpack_require__(222),"alt":""}})])]),_vm._v(" "),(_vm.companyInfo.factoryQcScoreObj)?_c('div',{staticClass:"g-flex right"},[_c('div',{staticClass:"text-c"},[_c('div',{staticClass:"tip"},[_vm._v("\n                    用户口碑\n                  ")]),_vm._v(" "),_c('div',{staticClass:"tip"},[_vm._v("\n                    "+_vm._s(_vm.companyInfo.factoryQcScoreObj.avgNum)+"分\n                  ")]),_vm._v(" "),_c('div',{staticClass:"star-wrap"},[_c('Star',{attrs:{"out-width":100,"out-height":20,"decimal":_vm.companyInfo.factoryQcScoreObj.avgNum/5}})],1),_vm._v(" "),_c('div',{staticClass:"reviews m-t-10"},[_c('span',[_vm._v(_vm._s(_vm.companyInfo.factoryQcScoreObj.dpnum)+"条")]),_vm._v("有价值点评\n                  ")])])]):_vm._e()]),_vm._v(" "),_c('div',{staticClass:"relate-product rank-list-wrap"},[(_vm.productList.length)?_c('div',{staticClass:"product-list m-t-20"},_vm._l((_vm.productList),function(item,index){return _c('div',{key:index,staticClass:"product-item g-flex",attrs:{"span":24}},[_c('div',{staticClass:"pro-logo"},[_c('nuxt-link',{attrs:{"to":{name:'product-detail-id', params:{ id: item.ID}},"target":"_blank"}},[_c('img',{attrs:{"src":"https://www.xuanxingbao.com/xxb_mark.png","alt":item.NAME}})])],1),_vm._v(" "),_c('div',{staticClass:"pro-info"},[_c('div',{staticClass:"title"},[_c('nuxt-link',{staticClass:"link",attrs:{"to":{name:'product-detail-id', params:{ id: item.ID}},"target":"_blank"}},[_vm._v("\n                        "+_vm._s(item.NAME)+"\n                      ")])],1),_vm._v(" "),(item.avgNum)?_c('div',[_c('div',{staticClass:"g-flex",staticStyle:{"align-items":"center"}},[_c('span',{staticClass:"count"},[_vm._v(_vm._s(item.avgNum)+"分")]),_vm._v(" "),_c('Star',{attrs:{"out-width":80,"out-height":16,"decimal":item.avgNum/5}})],1),_vm._v(" "),_c('div',{staticClass:"reviews m-t-10"},[_vm._v("\n                        "+_vm._s(item.dpnum)+"条有价值点评\n                      ")])]):_c('div',{staticClass:"no-review",staticStyle:{"font-size":"13px","margin-top":"20px"}},[_c('span',{staticStyle:{"margin-right":"10px"}},[_vm._v("暂无点评")])])]),_vm._v(" "),_c('div',{staticClass:"btn-wrap"},[(item.avgNum)?_c('nuxt-link',{staticClass:"check-comment",attrs:{"to":{name:'product-detail-id', params:{ id: item.ID}},"target":"_blank"}},[_vm._v("\n                      查看点评\n                    ")]):_c('span',{staticClass:"review-btn",on:{"click":function($event){$event.stopPropagation();return _vm.handleBannerPopShow.apply(null, arguments)}}},[_vm._v("马上去点评")])],1)])}),0):_c('div',{staticStyle:{"width":"100%","height":"400px"}},[_c('no-data',[_c('div',{staticStyle:{"font-size":"14px"},attrs:{"slot":"txt"},slot:"txt"},[_vm._v("\n                    暂无数据~\n                  ")])])],1)])]),_vm._v(" "),_c('a-col',{attrs:{"span":8}},[_c('Slider',[_c('div',{staticClass:"report-wrap",attrs:{"slot":"report-txt"},slot:"report-txt"},[_c('div',{staticClass:"txt1"},[_vm._v("\n                  "+_vm._s(_vm.categoryName)+"选型\n                ")]),_vm._v(" "),_c('div',{staticClass:"txt2"},[_vm._v("\n                  用户口碑报告\n                ")])])]),_vm._v(" "),_c('div',{staticClass:"contact-btn",on:{"click":_vm.formHandleShow}},[_vm._v("\n              请厂商联系我\n            ")]),_vm._v(" "),_c('Slider',[_c('div',{staticClass:"g-flex space-between",attrs:{"slot":"slider-title"},on:{"click":_vm.navigateToRank},slot:"slider-title"},[_c('span',[_vm._v(_vm._s(_vm.categoryName)+"厂商口碑排名")]),_vm._v(" "),_c('span',{staticStyle:{"font-size":"14px","color":"#a9a9a9","cursor":"pointer"}},[_vm._v("查看完整")])]),_vm._v(" "),(_vm.hotCompanyList.length)?_c('div',{staticClass:"slider-nav-bar",attrs:{"slot":"slider-nav-bar"},slot:"slider-nav-bar"},[_c('h3',[_vm._v("热门厂商")]),_vm._v(" "),_vm._l((_vm.hotCompanyList),function(item,index){return _c('div',{key:index,staticClass:"view-wrap"},[_c('rankListItem',{attrs:{"item":item,"index":index,"category-id":_vm.categoryId}})],1)})],2):_vm._e(),_vm._v(" "),(_vm.challengerList.length)?_c('div',{staticClass:"slider-nav-bar",attrs:{"slot":"slider-nav-bar"},slot:"slider-nav-bar"},[_c('h3',[_vm._v("挑战者")]),_vm._v(" "),_vm._l((_vm.challengerList),function(item,index){return _c('div',{key:index,staticClass:"view-wrap"},[_c('rankListItem',{attrs:{"item":item,"index":index,"category-id":_vm.categoryId}})],1)})],2):_vm._e(),_vm._v(" "),(_vm.noReviewList.length)?_c('div',{staticClass:"slider-nav-bar",attrs:{"slot":"slider-nav-bar"},slot:"slider-nav-bar"},[_c('h3',[_vm._v("暂无点评的厂商")]),_vm._v(" "),_vm._l((_vm.noReviewList),function(item,index){return _c('div',{key:index,staticClass:"view-wrap"},[_c('div',{staticClass:"view"},[_c('div',{staticClass:"g-flex space-between pad-20",staticStyle:{"width":"100%"}},[_c('nuxt-link',{staticStyle:{"color":"#222222"},attrs:{"target":"_blank","to":{name: 'reputation-id',params: {id: _vm.categoryId},query: {factory_id: item.qcid}}}},[_vm._v("\n                        "+_vm._s(item.factory_short_name || item.qcname)+"\n                      ")])],1)])])})],2):_vm._e()])],1)],1)],1)],1)],2),_vm._ssrNode(" "),_c('contact',{ref:"child",attrs:{"form-show":_vm.formShow},on:{"formHide":_vm.formHandleHide,"submit":_vm.submitForm}}),_vm._ssrNode(" "),_c('banner-pop',{directives:[{name:"show",rawName:"v-show",value:(_vm.bannerPopShow),expression:"bannerPopShow"}],on:{"handleBannerPopHide":_vm.handleBannerPopHide}}),_vm._ssrNode(" "),_c('rightNav',[_c('qrcode')],1),_vm._ssrNode(" "),_c('Footer')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/reputation/_id.vue?vue&type=template&id=cc7f5aa4&
...
var contact = __webpack_require__(184);
...
var breadCrumb = __webpack_require__(174);
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  head() {
    return {
      title: this.factory_short_name + this.categoryName + '怎么样？_' + this.factory_short_name + '公司怎么样？_' + this.factory_short_name + this.categoryName + '多少钱？选型宝',
      meta: [{
        hid: 'description',
        name: 'description',
        content: '想了解' + this.factory_short_name + this.categoryName + '怎么样、' + this.factory_short_name + '公司怎么样、' + this.factory_short_name + this.categoryName + '多少钱?就上选型宝, 企业级软件的大众点评'
      }, {
        hid: 'keywords',
        name: 'keywords',
        content: this.factory_short_name + '_' + this.factory_short_name + this.categoryName
      }]
    };
  }
...
installComponents(component, {Header2: __webpack_require__(167).default,Slider: __webpack_require__(175).default,Footer: __webpack_require__(168).default})
