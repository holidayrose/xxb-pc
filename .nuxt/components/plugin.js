...
const components = {
  ...
  Header2: () => import('../..\\components\\Header2.vue' /* webpackChunkName: "components/header2" */).then(c => wrapFunctional(c.default || c)),
  ...
  CompareAddPro: () => import('../..\\components\\compare\\addPro.vue' /* webpackChunkName: "components/compare-add-pro" */).then(c => wrapFunctional(c.default || c)),
  ...
  HeaderPHeader2: () => import('../..\\components\\header\\pHeader2.vue' /* webpackChunkName: "components/header-p-header2" */).then(c => wrapFunctional(c.default || c)),
